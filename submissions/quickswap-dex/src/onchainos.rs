...
/// Uses `onchainos wallet addresses` and parses data.evm[].address where chainIndex == chain_id.
pub fn resolve_wallet(chain_id: u64) -> anyhow::Result<String> {
    ...
    if let Some(evm_list) = json["data"]["evm"].as_array() {
        ...
        // Fallback: use first EVM address if chain-specific not found
...
/// `--force` is always appended — required for all DEX write operations on QuickSwap.
